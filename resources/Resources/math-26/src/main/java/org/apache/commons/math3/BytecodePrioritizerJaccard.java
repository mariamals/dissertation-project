...
public class BytecodePrioritizerJaccard {
    ...
    private static final Path OUTPUT_CSV = Paths.get( 
        "C:/Users/marya/Downloads/Resources/Resources/math-26/fast_bytecode_jaccard.csv"
    );

    
    private static final int SHINGLE_SIZE = 1;
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.printf("MinHash-Jaccard completed in %.3f seconds%n", duration);
    }
